...
%%
%% <ul> <li> <a>PutFile</a>, which adds or modifies a file in a specified
%% repository and branch.
%%
%% </li> </ul> Information about committed code in a repository, by calling
%% the following:
%%
%% <ul> <li> <a>GetBlob</a>, which returns the base-64 encoded content of an
...
%% @doc Adds or updates a file in an AWS CodeCommit repository.
