...
%% Storage Gateway Regions and Endpoints:</a> Provides a list of each region
%% and endpoints available for use with AWS Storage Gateway.
%%
...
%% @doc Creates a file share on an existing file gateway. In Storage Gateway,
%% a file share is a file system mount point backed by Amazon S3 cloud
%% storage. Storage Gateway exposes file shares using a Network File System
%% (NFS) interface. This operation is only supported in the file gateway
%% type.
%%
...
%% @doc Gets a description for one or more file shares from a file gateway.
...
%% @doc Updates a file share. This operation is only supported in the file
%% gateway type.
%%
