...
%%
%% </li> <li> <code>IN_SYNC</code>: Propagation is complete.
%%
%% </li> </ul>
...
%% <code>waf:UpdateWebACL</code> and <code>waf-regional:UpdateWebACL</code>.
...
%% want AWS WAF to inspect and, if you want AWS WAF to inspect a header, the
%% name of the header.
%%
...
%% which CloudFront requests you want to allow, block, or count. For example,
...
%%
%% </li> <li> The <code>Rules</code> that you want to add and/or delete. If
