...
%% for your scalable AWS resources. You can use Application Auto Scaling to
%% accomplish the following tasks:
%%
%% <ul> <li> Define scaling policies to automatically scale your AWS
%% resources
%%
...
%%
%% </li> </ul> Application Auto Scaling can scale the following AWS
%% resources:
%%
...
%%
%% </li> <li> Amazon SageMaker endpoints. For more information, see <a
...
%% href="http://aws.amazon.com/autoscaling">AWS Auto Scaling</a>.
%%
...
%% until you register the scalable target using
%% <a>RegisterScalableTarget</a>.
%%
...
%% resource that Application Auto Scaling can scale out or scale in. After
%% you have registered a scalable target, you can use this operation to
%% update the minimum and maximum values for its scalable dimension.
%%
%% After you register a scalable target, you can create and apply scaling
%% policies using <a>PutScalingPolicy</a>. You can view the scaling policies
%% for a service namespace using <a>DescribeScalableTargets</a>. If you no
%% longer need a scalable target, you can deregister it using
