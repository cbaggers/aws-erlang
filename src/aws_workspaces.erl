...
%% @doc Creates the specified tags for the specified WorkSpace.
...
%% @doc Deletes the specified tags from the specified WorkSpace.
...
%% @doc Describes the specified tags for the specified WorkSpace.
...
%% @doc Describes the available WorkSpace bundles.
%%
